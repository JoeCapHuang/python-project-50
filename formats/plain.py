...
def gen_line(path, value_type, value):
    ...
    match value_type:
        ...
        case 'changed':
            ...
            action = f'updated. From {normalize_val(old_value)} to {normalize_val(new_value)}'
    if action:
        ...
        for key, value in node.items():
            ...
            match value_type:
                ...
                case 'added' | 'deleted' | 'changed':
                    lines.append(
                        gen_line(new_path, value_type, in_value if value_type != 'changed' else (old_value, new_value)))
        return lines
